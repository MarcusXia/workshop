...
//   }
	...
	setContextGroupBy: function(filter){
		...
		var aUrl = '/sap/hana/democontent/epmSP6/services/poWorklistQuery.xsjs?cmd=getTotalOrders'+'&groupby='+escape(filter)+'&currency=USD&filterterms=';
	...
	setGroupBy: function(oEvent,oController){
		...
		var aUrl = '/sap/hana/democontent/epmSP6/services/poWorklistQuery.xsjs?cmd=getTotalOrders'+'&groupby='+escape(groupBy)+'&currency=USD&filterterms=';
