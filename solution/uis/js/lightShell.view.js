sap.ui.jsview("epm_po_worklist.lightShell", {
	...
	createContent : function(oController) {
		var oSearchView = sap.ui.view({id:"po_search_view", viewName:"epm_po_worklist.Search", type:sap.ui.core.mvc.ViewType.JS});
		var oTableView = sap.ui.view({id:"po_table_view", viewName:"epm_po_worklist.Table", type:sap.ui.core.mvc.ViewType.JS});
		var oDetailView = sap.ui.view({id:"po_detail_view", viewName:"epm_po_worklist.Detail", type:sap.ui.core.mvc.ViewType.JS});		
		...
		oAppHeader.setLogoSrc("/sap/hana/democontent/epmSP6/ui/images/sap_18.png");
