sap.ui.jsview("epm_po_worklist.Table", {
      ...
      createContent : function(oController) {
    	 ...
    	 var oModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epm/services/poWorklist.xsodata/", false);
         ...
         //Table Column Definitions
          ...
          oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("product")}), 
        	  template: oControl, sortProperty: "PRODUCTID", filterProperty: "PartnerId" }));
