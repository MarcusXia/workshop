...
function buildGeneralTab(oController,oTabStrip){
	  ...
	  var oText = new sap.ui.commons.TextView("txtPurchaseOrderId",{tooltip: oBundle.getText("poid"), editable:false});
	  ...
	  //Partner ID
	  var oText2 = new sap.ui.commons.TextView("txtPartnerId",{tooltip: oBundle.getText("bpart"), editable:false});
	  ...
	  var oText = new sap.ui.commons.TextView("LoginName_1",{tooltip: oBundle.getText("changeby"), editable:false});
	  ...
	  //Company Name
	  var oText2 = new sap.ui.commons.TextView("txtCompanyName",{tooltip: oBundle.getText("company"), editable:false});
...
function buildItemsTab(oController,oTabStrip){
	...
	var oModelItem = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epm/services/poWorklistJoin.xsodata/", false);
    var oControl;
    ...
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("item")}), 
    	template: oControl, sortProperty: "PURCHASEORDERITEM", filterProperty: "PURCHASEORDERITEM" }));
    ...
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("product_name")}), 
    	template: oControl, sortProperty: "PRODUCTNAME", filterProperty: "PRODUCTNAME" }));
    
    //Category
    oControl = new sap.ui.commons.TextView().bindProperty("text","CATEGORY");
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("product_cat")}), 
    	template: oControl, sortProperty: "CATEGORY", filterProperty: "CATEGORY" }));
    
    //Quantity
    oControl = new sap.ui.commons.TextView().bindText("QUANTITY",numericFormatter);
    oControl.setTextAlign("End");
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("quantity")}), 
    	template: oControl, sortProperty: "QUANTITY", filterProperty: "QUANTITY", hAlign: sap.ui.commons.layout.HAlign.End}));
    ...
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("quantity_unit")}), 
    	template: oControl, sortProperty: "QUANTITYUNIT", filterProperty: "QUANTITYUNIT"}));  
