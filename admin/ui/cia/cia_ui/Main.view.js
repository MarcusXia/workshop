sap.ui.jsview("cia_ui.Main", {
	...
	createContent : function(oController) {
		...
		oController.oShell = new sap.ui.ux3.Shell("myShell", {
			...
			appIconTooltip : "SAP",
			appTitle : "Client Instance Assignment",
	    ...
	    if (url.search("/workshop/admin/ui/cia/requestOld.html") != -1) {
			var oEntryView = sap.ui.view({id:"request_view", viewName:"cia_ui.Request", type:sap.ui.core.mvc.ViewType.JS});
			oLayout.createRow(oEntryView);
	    }else if (url.search("/workshop/admin/ui/cia/displayOld.html") != -1){
			var oTableView = sap.ui.view({id:"table_view", viewName:"cia_ui.Table", type:sap.ui.core.mvc.ViewType.JS});
